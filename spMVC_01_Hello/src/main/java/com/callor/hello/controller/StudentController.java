...
public class StudentController {
	...
	/*
	 * form 의 input box 에 입력된 데이터(문자열)은 controller method 의 매개변수의
	 * 1:1 로 매칭된다
	 * 이때 input box 의 name 속성의 Dto 클래스의 변수명과 일치해야 한다
	 * 
	 * @ResponseBody 
	 * method 문자열을 return 하면 원래 views/*.jsp 파일을 찾아서 rendering한 후
	 * client 로 보낸다 하지만 @ResponsBody 가 설정되면,
